...
- **Shipped ingress:** [`../MODE-C-ONE-TIME-HANDLE.md`](../MODE-C-ONE-TIME-HANDLE.md)
...
assertion-handle notes were replaced by **Mode C** (SD-009), which authorizes
stock, unmodified RDP clients via a single-use server-side handle. The
...
| `MODE-A-NATIVE-RDSAAD.md`, `MODE-B-GATEWAY-RDSAAD.md` | `MODE-C-ONE-TIME-HANDLE.md` (SD-009) |
