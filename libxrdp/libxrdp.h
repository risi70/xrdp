...
/* Length of a Broker-RDP Handle in routing-token/cookie form */
...
struct xrdp_iso
{
    ...
    /* Strictly parsed Broker-RDP Handle from the X.224 routing token/cookie,
     * empty when absent. Only captured when Broker-RDP Handle ingress is enabled. */
