# Vendored from broker-auth/tools/baf_handle_client.py — do not edit here.
# build-plugin.sh and tests/test_vendored_sync.py fail when this copy drifts
# from the original; update the original and re-vendor instead.
