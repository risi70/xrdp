...
[broker-auth/reference-broker/README.md](broker-auth/reference-broker/README.md).
Superseded design tracks and phase notes are kept under
[broker-auth/archive/](broker-auth/archive/).
